...
export class ProductosService {
  ...
  addProducto(dueHacienda,cantCabeza,cantMedia,fechaFaena,cantKilos,  nroTropa) {
    return this.http.post("http://localhost/Frigorifico/controllers/productosControllers.php?id=add",
  ...
  editProducto(dueHacienda,cantCabeza,cantMedia,fechaFaena,cantKilos,  nroTropa ,idProductos) {
    return this.http.post("http://localhost/Frigorifico/controllers/productosControllers.php?id=edit",
      {'dueHacienda': dueHacienda, 'cantCabeza': cantCabeza,
      'cantMedia': cantMedia, 'fechaFaena': fechaFaena,
...
productos:any;
  getProductos() {
  return this.http.get("http://localhost/Frigorifico/controllers/productosControllers.php?id=getProd")
    .map(resultado => {
...
deleteCategoria(idProductos){
    return this.http.post("http://localhost/Frigorifico/controllers/productosControllers.php?id=delete", { 'idProductos': idProductos })
